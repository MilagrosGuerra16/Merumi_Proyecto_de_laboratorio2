<?php
// Muestra errores de PHP (útil para desarrollo)
...
// Bloquea accesos que no sean por POST
...
$id_tipo    = 2; // Tipo de persona: cliente
...
// Ejecuta la consulta y redirige si sale bien
if ($sql->execute()) {
